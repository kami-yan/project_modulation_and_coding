function H = generate_ldpc(M, N, method, noCycle, onePerCol)

% Creates low density parity check matrix of 1/2 code rate
%
% INPUTS:
%  - M : Size of syndrom
%  - N : Size of codeword
%  - method : {0} ones placed at random in each column, {1} ones placed at random in each column and row
%  - noCycle : {0} Ignore, {1} Eliminate length-4 cycles
