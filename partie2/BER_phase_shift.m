...
for k = 1:nIterations
    progress = (angle_index-1)/length(angles)+(avg-1)/nb_avg*1/length(angles)+ 1/length(angles)*1/nb_avg*k / nIterations  ;
...
legend('0°','1°','3°','5°','10°','20°','30°')
title('BER with phase shift 16QAM')
ylabel('BER')
xlabel('Eb/N0')
