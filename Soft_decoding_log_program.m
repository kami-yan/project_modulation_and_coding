...
bits_p_sym = 1; % number of bits per symbol. 4
nbr_sym_data = 2^14;
...
%______________________Soft decoding here_____________________________________________
    ...
    [bits_stream_5it_soft] = soft_decoding_log(r,H,var(Y),2);
    [bits_stream_10it_soft] = soft_decoding_log(r,H,var(Y),3);
    [bits_stream_20it_soft] = soft_decoding_log(r,H,var(Y),10);
